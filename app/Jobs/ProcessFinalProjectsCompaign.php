...
use App\Mail\FinalProjectsCampaign;
...
class ProcessFinalProjectsCompaign implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        Mail::to($this->email)->send(new FinalProjectsCampaign($this->name, $this->recipientCategory));
    }
}
