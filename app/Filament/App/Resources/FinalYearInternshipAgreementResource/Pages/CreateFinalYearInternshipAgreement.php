...
use App\Models\ApprenticeshipAgreementContact;
                    ...
                    Forms\Components\Group::make()
                        ->schema([
                            Forms\Components\Select::make('organization_id')
                                ->label('Organization')
                                ->helperText('Select an existing organization or create a new one')
                                ->hint('The organization that will host the internship')
                            ...
                            Forms\Components\Placeholder::make('organization_info')
                                ...
                                ->content(function ($get) {
                                    return $get('organization_id') ? 'Organization Name: ' .
                                    $get('organization_info')['name'] . ' - ' .
                                    $get('organization_info')['country'] . ' - ' .
                                    $get('organization_info')['city'] . ' - ' .
                                    $get('organization_info')['address'] :
                    ...
                    Forms\Components\Grid::make(2)
                        ->schema([
                            Forms\Components\Section::make('Company Representative')
                                ->description('The person who will sign the agreement on behalf of the organization')
                                ->schema([
                                    Forms\Components\Placeholder::make('organization_name')
                                        ->label('')
                                        ->content(fn ($get) => $get('organization_id')),
                                    Forms\Components\Select::make('parrain_id')
                                        ...
                                        ->createOptionUsing(function ($data, Get $get) {
                                            ...
                                            $parrain = new ApprenticeshipAgreementContact;
                                            $parrain->fill($data);
                            ...
                            Forms\Components\Section::make('Internal Supervisor')
                                ...
                                ->schema([
                                    Forms\Components\Select::make('internal_supervisor_id')
                                        ...
                                        ->helperText(__('The supervisor from the academic institution'))
                                        ->preload()
                                        ->relationship(
