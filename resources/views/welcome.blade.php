...
<head>
    ...
    <!-- # CSS Plugins -->
    <link rel="stylesheet" href="frontpage/plugins/slick/slick.css">
    <link rel="stylesheet" href="frontpage/plugins/font-awesome/fontawesome.min.css">
    <link rel="stylesheet" href="frontpage/plugins/font-awesome/brands.css">
    <link rel="stylesheet" href="frontpage/plugins/font-awesome/solid.css">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        ...
                        <p class="mb-4">L'équipe de la direction adjointe des stages et relations entreprises vous
                            ...
                            aujourd'hui, nous sommes là pour vous aider à mettre en valeur vos atouts pour bien la
                            démarrer.

                        </p>
                        <a type="button" class="btn btn-primary" href="/app">{{__('Continue to Student portal')}}<span
                                style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="frontpage/images/undraw_career_progress_ivdb.svg"
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    <div class="footer-widget">
                        <div class="d-flex flex-column justify-content-between">
                            <img src="frontpage/images/logo-colors.svg" alt="Logo 1" class="my-3">
                            <img src="frontpage/images/go-digital-color.svg" alt="Logo 2" class="my-3">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-4">
