...
<body>
    ...
    <h1 class="text-2xl font-bold text-center mb-2 mt-10">
        CONVENTION DE STAGE "OUVRIER"
    </h1>
    <h2 class="text-xs text-center mb-10">
    ...
    <div class="text-center text-sm font-semibold mt-2">
        Et MENNANE IT SERVICES
    </div>
    <div class="text-center text-xs">
        Situé au 26 rue boulard 75014 Paris
    </div>
    <div class="text-center text-xs">
        Représenté par M. MENNANE Mohamed
    </div>
    <div class="text-center text-sm font-semibold mt-2">
    ...
    <div class="p-6 bg-white shadow-md rounded-lg">
        ...
        <p class="text-xs mb-4">
            L'INPT forme des ingénieurs en Réseaux de Télécommunications, de l’Informatique et du Multimédia. Ces
            ingénieurs pourront être
            de futurs responsables pour des entreprises, dans un monde ouvert aux dynamiques des réseaux et des systèmes
            d'informations.
            La mise en situation professionnelle est une étape importante dans la formation d’ingénieurs, elle permet
            aux élèves de se
            ...
            (Stage Ouvrier, Stage Technique et Stage de Projet de Fin d’Études).
            Durant le stage ouvrier dont la durée est de 4 semaines ou plus, l’élève ingénieur occupe généralement un
            poste où il se familiarise
            avec les conditions de travail et observe le fonctionnement de l’organisme d’accueil.
        </p>
        <h2 class="text-base font-semibold mb-2">Article 1</h2>
        <p class="text-xs mb-2">
            La présente convention règle les rapports entre l’organisme d’accueil d'une part, l’INPT et le stagiaire
            d'autre part.
            Cette convention concerne l’élève ingénieur :
            M. EL MOUMEN HAMZA, élève ingénieur de la 1ère année du cycle INE de l’INPT.
        </p>
        <h2 class="text-base font-semibold mb-2">Article 2</h2>
        <p class="text-xs mb-2">
            L’étudiant(e) sera encadré(e) par un Responsable de stage désigné par l'organisme d'accueil M. Mennane
            Mohamed
            Le thème du stage est établi d'un commun accord entre l’organisme d’accueil et l’élève ingénieur.
        </p>
        <h2 class="text-base font-semibold mb-2">Article 3</h2>
        <p class="text-xs mb-2">
            Thème du stage : Développement d’une application de création de facture
            La durée du stage est fixée à 4 semaines , du 20/07/2022 au 20/08/2022.
        </p>
        ...
        <p class="text-xs mb-2">
            ...
            concerne l'horaire et le
            respect du secret professionnel.
        </p>
    </div>
    <div class="p-4 text-gray-500">
        <p class="text-xs mb-1">Av. Allal El Fassi,</p>
        <p class="text-xs mb-1">Madinat Al Irfane,</p>
        <p class="text-xs mb-1">Rabat - Maroc</p>
        <p class="text-xs mb-1">Tél. : + 212 5 37 77 30 77</p>
        <p class="text-xs mb-1">Fax : + 212 5 37 77 30 44</p>
        <p class="text-xs mb-1">https://www.inpt.ac.ma</p>
    </div>
    ...
    <div class="p-6 bg-white shadow-md rounded-lg">
        ...
        <p class="text-xs mb-2">
            A la fin du stage, l'organisme d’accueil est prié d’établir une attestation mentionnant la période du stage.
            ...
            moyen d'une fiche d'évaluation élaborée par les soins de l’INPT.
            Cette lettre sera envoyée à l’attention du Directeur Adjoint chargé des Relations avec les Entreprises, par
            fax au N° 00–212– 537–
            77–30–44.
        </p>
