...
<body class="text-justify text-xs sm:text-sm md:text-base lg:text-lg">
    ...
    <div class="text-xs mb-2">
        <p>Concernant le stage de Fin d’études de
            <strong>{{$internship->student->long_full_name}}</strong>, élève ingénieur de la filière
            <strong>
    ...
    {{-- <div class="p-6 bg-white"> --}}
        ...
        <div class="text-xs px-6">
            <ul class="list-disc list-inside ml-4 mt-2 mb-2 space-y-0">
                <li>
                    Encadrant Externe :
                    <strong>{{$internship->externalSupervisor->full_name}}</strong>,
            ...
            <ul class="list-disc list-inside ml-4 mt-2 mb-2 space-y-0">
                <li>
                    Chef de la filière :
                    <strong>{{$internship->student?->getProgramCoordinator()->long_full_name}}</strong>
                </li>
            </ul>
        </div>
        <p class="mt-2">
        ...
        {{-- <div class="flex flex-col justify-between min-h-screen"> --}}
            ...
            <footer class="text-gray-700 text-xs p-2 border-t fixed bottom-0">
