...
<body class="text-justify text-xs sm:text-sm md:text-base lg:text-lg">
    ...
    <div class="text-xs mb-2">
        <p>Concernant le stage de Fin d’études de
            <strong>{{$internship->student->long_full_name}}</strong>, élève ingénieur en 3<sup>ème</sup> année
            du
            cycle ingénieur
        ...
        <div class="text-xs px-6">
            <p class="mt-2">
                Encadrant Externe
                :<strong>{{$internship->supervisor->full_name}},{{$internship->supervisor->function}}</strong>
            </p>
            <p class="mt-1">
                et
            </p>
    ...
    {{-- <div class="p-6 bg-white"> --}}
        ...
        <div class="text-xs mt-2 mb-2">
            <p>La présente convention garantit que le règlement des stages inscrit au verso a été porté à la
                connaissance de
                l’entreprise et de l’élève et que ceux-ci en
            ...
            <div class="py-6 bg-white">
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        L’élève ingénieur est appelé à eﬀectuer un stage de PFE obligatoire pour l’obtention du diplôme
                        d’Ingénieur en
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs mb-2 inline">
                        Pendant la durée de son stage, le stagiaire reste placé sous la responsabilité de l’entreprise
                        d’accueil
                        tout en
                        demeurant étudiant de l’INPT. L'élève
                        stagiaire pourra revenir à l'Institut pendant la durée du stage, pour y suivre certains cours
                        demandés
                        explicitement par
                    ...
                    <p class="text-xs mt-1">
                        ...
                        enseignant de l’INPT et par un membre de l'entreprise chargé d'accueillir et d'accompagner le
                        stagiaire.
                    </p>
                </div>
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        Durant son stage, l'étudiant stagiaire est soumis à la discipline et au règlement intérieur de
                    ...
                    <p class="text-xs mt-1">
                        Toute sanction disciplinaire ne peut être décidée que par l'Institut. Dans ce cas, l’entreprise
                        informe l'Institut des
                        manquements et lui fournit éventuellement
                        les éléments constitutifs. L’entreprise, en accord avec le Directeur de l'INPT, peut mettre ﬁn
                        au
                        stage du stagiaire,
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        ...
                        sa soutenance devant un jury comprenant des représentants de l’entreprise accueillante et des
                        enseignants de l’INPT. La
                        présentation et le rapport
                        devront avoir été validés par l’entreprise au préalable et par l’enseignant encadrant à l’INPT.
                        L'étudiant s'engage à
                        fournir un rapport à l'organisme
                        d’accueil et à l'INPT au maximum une semaine avant la date de la soutenance.
                    </p>
                    <p class="text-xs mt-1">
                        A la ﬁn du stage et avant la soutenance, le Directeur de stage mentionné dans la convention est
                        prié
                        de
                        communiquer à
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        ...
                        publication, communication à des tiers sans accord préalable de la Direction de l'Entreprise, y
                        compris
                        le rapport de
                        stage. Cet engagement vaudra non
                        seulement pour la durée du stage mais également après son expiration. L'étudiant s'engage à ne
                        conserver, emporter, ou
                        prendre copie d'aucun
                        document ou logiciel, de quelque nature que ce soit, appartenant à l'Entreprise, sauf accord de
                        cette
                        dernière.
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        S’il advenait qu’un contrat de travail prenant effet avant la date de fin du stage soit signé
                        avec
