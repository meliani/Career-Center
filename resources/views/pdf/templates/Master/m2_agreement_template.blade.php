...
<body class="text-justify text-xs sm:text-sm md:text-base lg:text-lg">
    ...
    <div class="text-xs font-semibold mt-2">
        La présente convention règle les rapports de : <strong>{{$internship->organization->name}}</strong>
    </div>
    <div class="text-xs">
    ...
    <div class="text-xs font-semibold mt-0 mb-2">
        Ci-après désignée par Entreprise.
    </div>

    <div class="text-xs font-semibold">
        Avec : L’Institut National des Postes et Télécommunications (INPT-Rabat)
    </div>
    <div class="text-xs">
        Sis à Avenue Allal El Fassi, Madinat Al Irfane, Rabat - Maroc
    </div>
    <div class="text-xs">
        Représenté par Monsieur TAMTAOUI Ahmed, Directeur par intérim,
    </div>
    <div class="text-xs font-semibold mt-0 mb-2">
    ...
    <div class="text-xs mb-2">
        ...
        <div class="text-xs mt-2">
            ...
            <strong>{{$internship->ending_at->format('d/m/Y')}}</strong>, sous la responsabilité de :
            @else
            ..................... au ..................... , sous la responsabilité de :
            @endif
        </div>
    ...
    {{-- <div class="p-6 bg-white"> --}}
        <h2 class="text-base font-semibold mt-2 mb-0">ARTICLE SECOND :</h2>
        <div class="text-xs mt-2 mb-2">
            <p>
                La présente convention garantit que le règlement des stages inscrit au verso a été porté à la connaissance de l’entreprise et de l’élève et que ceux-ci en ont approuvé expressément toutes les clauses.
            </p>
    ...
    {{-- <div class="flex flex-col justify-between min-h-screen"> --}}
        <div class="flex flex-col justify-start items-center">
            ...
            <div class="py-6 bg-white">
                ...
                <div class="mt-2">
                    <h2 class="text-center text-lg font-semibold mb-0">REGLEMENT DES STAGES EN ENTREPRISE</h2>
                    <h3 class="text-sm font-semibold mb-0 inline">Art.1</h3>
                    <p class="text-xs inline">
                        l’étudiant est appelé à effectuer un stage de recherche PFE obligatoire pour l’obtention du Master. Il a pour objet de fournir un moyen pour juger l’étudiant sur son aptitude à effectuer une recherche documentaire et bibliographique relative à un sujet déterminé et en dégager l’essentiel, de résoudre des problèmes techniques de recherche et mettre en application, par une réalisation pratique, les résultats atteints.
                    </p>
                </div>
                <div class="mt-2">
                    <h3 class="text-sm font-semibold mb-0 inline">Art.2</h3>
                    <p class="text-xs mb-2 inline">
                        Pendant la durée de son stage, le stagiaire reste placé sous la responsabilité de l’entreprise d’accueil tout en demeurant étudiant de l’INPT. L'élève stagiaire pourra revenir à l'Institut pendant la durée du stage, pour y suivre certains cours demandés explicitement par le programme, participer à des réunions; Le cas échéant, les dates seront portées à la connaissance de l'Entreprise par l'Etablissement.
                    </p>
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        Durant son stage, l'étudiant stagiaire est soumis à la discipline et au règlement intérieur de l'Entreprise, notamment en ce qui concerne les horaires, 
                        <strong>la réglementation du travail, les règles d’hygiène et de sécurité en vigueur dans
                            l’entreprise.</strong>
                    </p>
                    <p class="text-xs mt-1">
                        Toute sanction disciplinaire ne peut être décidée que par l'Institut. Dans ce cas, l’entreprise informe l'Institut des manquements et lui fournit éventuellement les éléments constitutifs. L’entreprise, en accord avec le Directeur de l'INPT, peut mettre fin au stage du stagiaire, tout en respectant les dispositions fixées à l’article 4 ci-après.
                    </p>
                </div>
                <div class="mt-2">
                    ...
                    <p class="text-xs mt-1">
                        Dans le cas d’une interruption, d’une semaine au moins, pour motif circonstancié ou contexte exceptionnel, autorisée par l’entreprise, un avenant à la présente convention devra être signé au préalable par les cocontractants.
                    </p>
                    <p class="text-xs mt-1">
                        En cas de volonté d’une des trois parties (entreprise, INPT, étudiant(e)) d’interrompre définitivement le stage,
                        <strong>celle-ci devra immédiatement en informer les deux autres parties par écrit. Les raisons invoquées seront examinées en étroite concertation.</strong>
                ...
                <div class="mt-2">
                    ...
                    <p class="text-xs inline">
                        Le stagiaire est couvert par l'assurance de l’INPT contre les accidents pouvant survenir au cours du stage dans la limite de garantie de son assurance. 
                    </p>
                </div>
                <div class="mt-2">
                    <h3 class="text-sm font-semibold mb-0 inline">Art.6</h3>
                    <p class="text-xs inline">
                        A l’issue du stage, l’étudiant est tenu de présenter les résultats de son travail, tant par écrit dans son mémoire de fin d’études, qu'oralement lors de sa soutenance devant un jury comprenant des représentants de l’entreprise accueillante et des enseignants de l’INPT. La présentation et le rapport devront avoir été validés par l’entreprise au préalable et par l’enseignant encadrant à l’INPT. L'étudiant s'engage à fournir un rapport à l'organisme d’accueil et à l'INPT au maximum une semaine avant la date de la soutenance. 
                    </p>
                    <p class="text-xs mt-1">
                        A la fin du stage et avant la soutenance, le Directeur de stage mentionné dans la convention est prié de communiquer à l’école une évaluation du comportement du stagiaire et de la qualité du travail effectué.
                    </p>
                </div>
                <div class="mt-2">
                    <h3 class="text-sm font-semibold mb-0 inline">Art.7</h3>
                    <p class="text-xs inline">
                        Les étudiants stagiaires prennent l'engagement de n'utiliser en aucun cas les informations recueillies ou obtenues par eux pour en faire l'objet de publication, communication à des tiers sans accord préalable de la Direction de l'Entreprise, y compris le rapport de stage. Cet engagement vaudra non seulement pour la durée du stage mais également après son expiration. L'étudiant s'engage à ne conserver, emporter, ou prendre copie d'aucun document ou logiciel, de quelque nature que ce soit, appartenant à l'Entreprise, sauf accord de cette dernière. L’Entreprise peut demander une restriction de la diffusion du rapport, voire le retrait de certains éléments très confidentiels. Les personnes amenées à en connaître sont contraintes par le secret professionnel à n’utiliser ni ne divulguer les informations du rapport.
                    </p>
                </div>
                <div class="mt-2">
                    <h3 class="text-sm font-semibold mb-0 inline">Art.8</h3>
                    <p class="text-xs inline">
                        S’il advenait qu’un contrat de travail prenant effet avant la date de fin du stage soit signé avec l’Entreprise, la présente convention deviendrait caduque ; l’étudiant stagiaire perdrait son statut d’étudiant et ne relèverait plus de la responsabilité de l’Ecole. Ce dernier devrait impérativement en être averti avant signature du contrat.
                    </p>
                </div>
