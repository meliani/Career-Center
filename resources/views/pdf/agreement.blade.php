...
<body>
    ...
    <p>avec L’Institut National des Postes et Télécommunications (INPT) représenté par Monsieur Ahmed Tamtaoui,
        Directeur de
        l'Institut National des Postes et Télécommunications,</p>
    <p>Concernant le stage de Fin d’études de <strong>{{($internship->student->long_full_name)}}</strong>, élève
        ingénieur
        de
        la ﬁlière :<strong>
    ...
    <h1 class="page-title">REGLEMENT DES STAGES EN ENTREPRISE</h1>
